defmodule ClassEaseWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: ClassEaseWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ClassEaseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ClassEaseWeb.Gettext, "errors", msg, opts)
    end
  end
